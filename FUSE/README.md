...
The system utilizes an LLM to evaluate textual deviation across 6 specific dimensions, generating a quantifiable `Total_Deviation` score:
...
Create a .env file in the root directory. Add your API key to this file:
...
The script will process the predefined test cases and output a JSON object containing the scores for all 6 dimensions along with the calculated Total Deviation.